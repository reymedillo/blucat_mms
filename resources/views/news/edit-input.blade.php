  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
        <div class="panel-heading">{!! trans('global.news_edit') !!}</div>
        @if (count($errors) > 0)
        ...
        @if(!empty($news))
          <form class="form-horizontal" role="form" method="POST" action="/news/edit-confirm" enctype="multipart/form-data">          
            {!! csrf_field() !!} 
            <div class="form-group">
              <label class="col-md-1 control-label">{!! trans('global.news_content') !!}</label>
              <div class="col-md-11">
                {!! Form::textarea('content', $news->content, ['class' => 'field', 'size' => '40x20', 'maxlength' => '1000']) !!}
              </div>
            </div>
            <div class="form-group">
