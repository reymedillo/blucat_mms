  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
        <div class="panel-heading">{!! trans('global.news_create_confirm') !!}</div>
        <div class="panel-body"> 
          @if(!empty($news))
            <form class="form-horizontal" role="form" method="POST" action="/news/create-complete" enctype="multipart/form-data">
              {!! csrf_field() !!} 
              <div class="form-group">
                <label class="col-md-1 control-label">{{ trans('global.news_content') }}</label>
                <div class="col-md-11">
                  <div class="create-confirm-entity-html">
